                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="blog__item">
                                ...
                                <div class="blog__item__text">
                                    ...
                                    <p>C’est la saison des fraises, alors profitez-en ! Aujourd’hui, je vous propose ma recette de tartelettes aux fraises Mariguettes label rouge cultivées dans le Lot et Garonne. La Mariguette se reconnait facilement avec sa forme allongée et son bon goût sucré. C’est la “petite fille” de la gariguette et de la mara des bois ! Retrouvez ici un article complet :   […]</p>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="blog__item">
                                ...
                                <div class="blog__item__text">
                                    ...
                                    <p>Aujourd’hui, je vous propose la recette de la tarte rustique aux abricots ! C’est une recette super simple de tarte rustique ! Vous pouvez faire aussi bien la faire ...</p>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="blog__item">
                                ...
                                <div class="blog__item__text">
                                    <ul>
                                        <li><i class="fa fa-calendar-o"></i> 30 NOVEMBRE 2016</li>
                                        <li><i class="fa fa-comment-o"></i>21</li>
                                    </ul>
                                    <h5><a href="https://www.hervecuisine.com/recette/recette-tartare-vegetarien-avocat-melon/">Tartare végétarien avocat et melon</a></h5>
                                    <p>Une idée d’entrée super fraîche pour l’été: tartare melon et avocat avec un petit pesto basilic. Choisissez de bons avocats prêts à consommer, et du melon bien parfumé...</p>
                                    <a href="https://www.hervecuisine.com/recette/recette-tartare-vegetarien-avocat-melon/" class="blog__btn">Lire la suite<span class="arrow_right"></span></a>
                                </div>
                            </div>
                        </div>
